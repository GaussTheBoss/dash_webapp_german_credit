...
# Reading local files
training_data = pd.read_json("./data/training_data.json", lines=True, orient="records")
testing_data = pd.read_json("./data/testing_data.json", lines=True, orient="records")
